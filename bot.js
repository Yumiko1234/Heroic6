...
client.on('message', message => {
       if(message.content.startsWith(`.support`)){
           ...
           .setURL("https://discord.gg/qTpNVg2")
           .setTimestamp()
           .setColor("RANDOM")
...
var v1 = new Discord.RichEmbed()
  ...
  v1.setFooter("# | Heroic Bot |")
var heroo = new Discord.RichEmbed()
.setColor('#6a109d')
.setTimestamp(new Date())
.setThumbnail(client.user.avatarURL)
.setTitle('S_C BOT Info')
.setURL('https://discordapp.com/api/oauth2/authorize?client_id=531587886441824258&permissions=8&scope=bot')
.setAuthor(client.user.username,client.user.avatarURL)
...
client.on('message', msg => {
   ...
   client.on('message', msg => {
     if(msg.content === 'السلام عليكم')
                 setTimeout(function() {
   msg.reply('https://i.ytimg.com/vi/amKP_xzRaHM/maxresdefault.jpg')
                 }, 10000)
   });
   ...
   client.on('message', msg => {
     if(msg.content === 'باك')
                 setTimeout(function() {
   msg.reply('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSPnZGxLJhfdYmLBzoFpsgQcHJiI4GBojJVkbY-T3P81atAUzjsIA')
                 }, 10000)
   });
...
msg.delete();
            ...
            const misaka = new Set();
              ...
              if (misaka.has(msg.author.id)) {
               ...
               if (message.content.startsWith('.abc')){
                if (message.author.id !== '510087749378899968') return message.reply('** هذا الأمر قفط لصاحب البوت و شكراًً **')
    ...
    if (message.content === '.invite') {
           ...
           .setThumbnail(message.author.avatarURL)
           .addField("**رابط اضافه البوت**","**[https://discordapp.com/api/oauth2/authorize?client_id=531587886441824258&permissions=8&scope=bot] **")
    }
});
...
console.log('[38ab] Send By: ' + message.author.username)
 ...
 client.on('guildMemberRemove', member => {
        ...
        .setTitle(`بس ما بعرف ليش طلعت :raised_hand::skin-tone-1: :pensive:`)
        .setDescription(`مع السلامة :raised_hand::skin-tone-1: :pensive: `)
        .addField(':bust_in_silhouette:   تبقي',`**[ ${member.guild.memberCount} ]**`,true)
        .setColor('RED')
        .setFooter(`====اتمنا لك الاستمتاع====`, 'https://cdn.discordapp.com/emojis/530690967876009984.png?v=1')
...
client.on("ready", () => {
  function lol() {
    client.guilds.get('530674227519422465').roles.find("name", "Disco").setColor("RANDOM");
  };
...
client.login("NTMwMzUxMTEwMDQxMzcwNjQy.Dw-dNA.KD_GMb9rZ6Fno-HeV1xadB9uzXU");
